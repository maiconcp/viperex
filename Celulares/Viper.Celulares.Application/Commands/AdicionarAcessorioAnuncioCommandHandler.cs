...
{
    public class AdicionarAcessorioAnuncioCommandHandler : ICommandHandler<AdicionarAcessorioAnuncioCommand>
    {
        ...
        public void Handle(AdicionarAcessorioAnuncioCommand command)
        {
            command.Validate();            
